...
- [ ] **Phase 14: Web Frontend** - SvelteKit static app + read API; the 4 views as a reusable filterable/sortable data grid; client-side search + "did you mean?"; rich HTML tooltips; EQ theming. 🟡 4/4 plans executed (14-01 compute/data + 14-02 logic/theme ports + 14-03 read handlers/CORS + 14-04 the wired UI: DataGrid×4 + ItemTooltip + search + SiteShell, build green / 57 tests) — phase verification + code-review pending.
