...
- [x] **Phase 4: Differentiator Features** — Wiki gear-tier and per-class spell scrapes, `gear_check` and `spell_check` consolidated tabs, manual coin sidebar, cell-count monitoring. **(SHIPPED 2026-05-11 as v0.4.0; live smoke PASS for all 6 steps; 3 fix-pack patches landed during smoke.)**
- [x] **Phase 5: Search + Onboarding + Privacy Polish** — HtmlService search sidebar, custom menu, hide system tabs, weekly schema healthcheck, eviction workflow, README + Jekyll Pages site, auto-archive stale chars. **(SHIPPED 2026-05-11 as v1.0.0; DOC-02 fake-guildie smoke PASS; Pages site live at https://boejowen.github.io/SquireBot/; instructional images dropped mid-phase per user direction. Milestone v1.0 COMPLETE.)**
...
- [x] 05-05-PLAN.md — Jekyll Pages site + README shrink + distribution handoff (DOC-01, DOC-02, DOC-03) ✅ SHIPPED 2026-05-11 (commits df8c2fd + 482f19d + 8d1e332 + b668e75; Pages site live at https://boejowen.github.io/SquireBot/; instructional images dropped mid-phase per user direction 2026-05-11; DOC-02 fake-guildie smoke PASS end-to-end; distribution report N=1 M=1 — dev-workbook only; user authorized ship `phase-5-shipped` 2026-05-11)
**UI hint**: yes
